...
public class MenuScreen implements Screen {
    ...
    public MenuScreen(Main game, OrthographicCamera camera) {
        this.game = game;
        this.camera = camera;
    ...
    public void show() {
        ...
        startButton.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                ScreenManager.getInstance().setScreenWithFade(ScreenType.LEVEL1_SELECT, MenuScreen.this, 1.5f);
            }
        });
        ...
        cubeButton.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                ScreenManager.getInstance().setScreenWithFade(ScreenType.SKIN, MenuScreen.this, 1.5f);
            }
        });
        ...
        cogButton.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y) {
                ScreenManager.getInstance().setScreenWithFade(ScreenType.SETTINGS, MenuScreen.this, 1.5f);
            }
        });
